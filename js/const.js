...
const DEFAULT_PRICE_FOR_HOUSING = {
  low: 10000,
  high: 50000,
}
...
export {TYPES_OF_APARTMENT, CHECKOUT_TIMES, FACILITIES, SOURCES_OF_PHOTOS, QUANTITY_OF_RANDOM_ANNOUNCEMENT, FIRST_VALUE_OF_LATITUDE, SECOND_VALUE_OF_LATITUDE,
  FIRST_VALUE_OF_LONGITUDE, SECOND_VALUE_OF_LONGITUDE, NUMBER_OF_COORDINATE_POINTS, MIN_RANDOM_PRICE, MAX_RANDOM_PRICE, MAX_GUESTS_NUMBER, MAX_NUMBER_ROOMS, MIN_NUMBER_ROOMS, MIDDLE_NUMBER_ROOMS, 
  ...
  SELECT_OF_TWO_ROOMS_ON_PAGE, SELECT_OF_THREE_ROOMS_ON_PAGE, SELECT_OF_MAX_ROOMS_ON_PAGE, SERVER_URL_FOR_GET, SERVER_URL_FOR_POST, DEFAULT_PARAMETERS,
  DEFAULT_PRICE_FOR_HOUSING, RENDERING_DELAY, ESCAPE_KEY, ESC_KEY, MAP_SCALE
};
